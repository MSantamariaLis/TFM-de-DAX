...
class RNNModel(BaseNeuralModel):

    def __init__(self, model_name = 'RNN', custom_params = None, ids_col: str = 'unique_id', date_col: str = 'ds', label_col:str = 'y' ):
        super().__init__(model_name, custom_params, ids_col, date_col, label_col)

        self.model = RNN # do not change this
