...
class RandomForestModel(BaseMLModel):
    def __init__(self, model_name='RandomForest', custom_params = None, ids_col: str = 'unique_id', date_col: str = 'ds', label_col = 'y' ):
        super().__init__(model_name, custom_params, ids_col, date_col, label_col)

        self.model = RandomForestRegressor # do not change this
